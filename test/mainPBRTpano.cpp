...
int main(int argc, char **argv)
{
    ...
    int nc = 2*ori.intrinsic()->width();
    cout << "focal " << ori.intrinsic()->m_focal << endl;
    Ori ori_pano(ori);
    ori_pano.intrinsic()->width(nc);
    ori_pano.intrinsic()->cPPA( nc/2);
    ori_pano.intrinsic()->lPPA( nl/2);
    ori_pano.intrinsic()->m_focal = ori.intrinsic()->m_focal;
    ori_pano.intrinsic()->m_distortion=NULL;
...
//        ori.ImageAndDepthToGround(c,l,1.,x1,y1,z1);
        ori_pano.ImageAndDepthToGround(c,l,0.,x0,y0,z0);
        ori_pano.ImageAndDepthToGround(c,l,1.,x1,y1,z1);
